...
const sqlRequestOrdersTableArchived = () => 
...
const ordersTableDataArchived = () => {
    return new Promise((resolve, reject) => {
        connection.query(sqlRequestOrdersTableArchived(), (err, results) => {
...
module.exports = { ordersTableDataArchived };